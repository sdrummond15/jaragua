...
$document->addStyleSheet(JURI::base(true) . '/modules/mod_contact_social_footer/assets/css/style.css');
$document->addScript(JURI::base(true) . '/modules/mod_contact_social_footer/assets/js/script.js');
