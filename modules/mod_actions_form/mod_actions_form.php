...
require JModuleHelper::getLayoutPath('mod_actions_form', $params->get('layout', 'default'));

$document = JFactory::getDocument();
$document->addStyleSheet(JURI::base(true) . '/modules/mod_actions_form/assets/css/style_actions_form.css');
